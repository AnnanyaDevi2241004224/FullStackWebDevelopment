...
console.log("===>",document.body.firstElementChild.childElementCount);
...
console.log(document.body.children[1].rows[1].rowIndex);
console.log(document.body.children[1].rows[1].columnIndex);
